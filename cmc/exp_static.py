...
def exp():
    n_exp = 10
    steps = np.array([50000],dtype=int) #np.linspace(50000, 50001, num=1, dtype=int)
    nodes = np.array([32],dtype=int) 
    layers = np.array([2],dtype=int)
    actorbatch = np.array([325],dtype=int)*np.ones(n_exp,dtype=int)
